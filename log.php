                  ...
                  <tbody>
                     ...
                     foreach ($select as $value) { ?>
                        ...
                        <tr>
                           ...
                           <td><a href="index.php?Login&edit&id=<?= $value['in_id'] ?>" class="text-decoration-none">✏️</a>
                              | <a href="process.php?delete&id=<?= $value['in_id'] ?>" class="text-decoration-none">❌</a>
                           </td>
                        </tr>
                  ...
                  <tbody>
                     ...
                     foreach ($select as $value) { ?>
                        ...
                        <tr>
                           ...
                           <td><a href="index.php?Logout&edit1&id=<?= $value['out_id'] ?>"
                                 class="text-decoration-none">✏️</a> |
                              <a href="process.php?delete1&id=<?= $value['out_id'] ?>" class="text-decoration-none">❌</a>
                           </td>
                        </tr>
