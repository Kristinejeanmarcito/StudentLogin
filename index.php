            ...
            foreach ($selectData as $data) { ?>
               ...
               <form action="process.php" method="post">
                  ...
                  <div class="mb-3 mt-2">
                     ...
                     <input type="text" class="form-control mb-3" id="fname" name="firstname" value="<?= $data['s_fname'] ?>" required>
                  </div>
                  <div class="mb-3">
                     <label for="lname">Lastname</label>
                     <input type="text" class="form-control mb-3" id="lname" name="lastname" value="<?= $data['s_lname'] ?>" required>
                  </div>
                  <div class="d-flex justify-content-evenly">
                     ...
                     <div class="mb-3" style="width:30%;">
                        ...
                        <input type="text" class="form-control mb-3" id="course" name="course" value="<?= $data['course'] ?>" required>
                     </div>
                  </div>
                  <div class="mb-3">
                     <label for="purpose">Purpose</label>
                     <input type="text" class="form-control mb-3" id="purpose" name="purpose" value="<?= $data['purpose'] ?>" required>
                  </div>
                  ...
                  <div class="d-flex justify-content-between">
                     <div class="mb-2 mt-3" style="width: 10%;">
                        <a class="btn btn-success" style="width:100%;" href="log.php" name="editLogin"><</a>
                     </div>
                     <div class="mb-2 mt-3">
